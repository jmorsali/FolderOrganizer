...
namespace MMS.Framework.Util_Extension.Number.Extensions
{
    public static class Utils
    {
        ...
        public static Age Age(this System.DateTime birthDate)
        {
        ...
        public static Age AgeAt(this System.DateTime birthDate, System.DateTime futureDate)
        {
		...
		private static void CalculateAge(System.DateTime adtDateOfBirth,System.DateTime referenceDate, out int noOfYears, out int noOfMonths, out int noOfDays)
        {
            System.DateTime adtCurrentDate = referenceDate;
            ...
            if (noOfDays < 0)
            {
                noOfDays += System.DateTime.DaysInMonth(adtCurrentDate.Year, adtCurrentDate.Month);
                noOfMonths--;
            }
